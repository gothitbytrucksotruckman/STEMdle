...
# Inspiration
Of course, this project wasn't possible without inspiration from the goat wordle itself. But the biggest inspiratioon that motivates me to create this project was [doctordle](https://doctordle.org/). All mechanics are inspired by doctordle, with some custom tweaks to fit the STEM context.
